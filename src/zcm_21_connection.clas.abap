CLASS zcm_21_connection DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    CONSTANTS:
      BEGIN OF co_switched_successfully,
        msgid TYPE symsgid VALUE 'Z21_CONNECTION',
        msgno TYPE symsgno VALUE '000',
        attr1 TYPE scx_attrname VALUE 'FLIGHTTYPE', "Hier
        attr2 TYPE scx_attrname VALUE 'attr2',
        attr3 TYPE scx_attrname VALUE 'attr3',
        attr4 TYPE scx_attrname VALUE 'attr4',
      END OF co_switched_successfully.

    DATA flighttype TYPE c LENGTH 1. "Muss dem Namen oben enstprechen
...
CLASS zcm_21_connection IMPLEMENTATION.
